...
% for w=1:1
    ...
    for ds_rate=[50, 100, 200]
        ...
        save(fullfile(pwd, 'dataset', 'ds_test_data', strcat('ds_fall_test_', num2str(ds_rate)), file_name), 'result');
        whos('-file',fullfile(pwd, 'dataset', 'ds_test_data/', strcat('ds_fall_test_', num2str(ds_rate)), file_name)) 
    end
end
...
% for w=1:1
    ...
    for ds_rate=[50, 100, 200]
        ...
        file_name = strcat(new_name, '_' ,num2str(ds_rate), '.mat');
        save(fullfile(pwd, 'dataset', 'ds_test_data', strcat('ds_nonfall_test_', num2str(ds_rate)), file_name), 'result');
        whos('-file',fullfile(pwd, 'dataset', 'ds_test_data', strcat('ds_nonfall_test_', num2str(ds_rate)), file_name)) 
    end
end