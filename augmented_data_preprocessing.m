...
for ds_rate=[50, 100, 200]
    ...
    fall_train_path=strcat('/home/jsw/FallDeFi/dataset/augmented/fall_tr_aug_', num2str(ds_rate), '/*.mat');
    nonfall_train_path=strcat('/home/jsw/FallDeFi/dataset/augmented/nonfall_tr_aug_', num2str(ds_rate), '/*.mat');
...
%     for w=1:1
        ...
        save(fullfile(pwd, 'dataset', 'augmented', strcat('fall_tr_aug_', num2str(ds_rate), '_wden_pca'), file_name), 'result');
        whos('-file',fullfile(pwd, 'dataset', 'augmented', strcat('fall_tr_aug_', num2str(ds_rate), '_wden_pca'), file_name))
    end
...
%     for w=1:1
        ...
        file_name = strcat(new_name, '_wden_pca.mat');
        save(fullfile(pwd, 'dataset', 'augmented', strcat('nonfall_tr_aug_', num2str(ds_rate), '_wden_pca'), file_name), 'result');
        whos('-file',fullfile(pwd, 'dataset', 'augmented', strcat('nonfall_tr_aug_', num2str(ds_rate), '_wden_pca'), file_name))
    end
end